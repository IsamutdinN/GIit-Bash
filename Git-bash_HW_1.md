...
####2)Создать папку
- $ mkdir S_1 //Название папки через пробел.В самом названии папки не допускается наличие пробелов.


####3)Зайти в папку
- $ cd S_1 //Название папки через пробел.


####4)Создать 3 папки
- $ mkdir W_1 W_2 W_3 //Названия папок отделяем друг от друга пробелом.
...
- $ touch T{_1,_2,_3}.txt J{_1,_2}.json             _//Создадутся файлы T_1.txt T_2.txt T_3.txt J_1.json J_2.json_ 
